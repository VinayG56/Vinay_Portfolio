  ...
  return (
    <>
      <div className="home_data">
        ...
        <h3 className="home_subtitle">Full Stack Web Developer / Competitive Coder / <br />Data Scientist / </h3>
        </div>
        <p className="home_description">I'm a creative Web Developer focused on user-friendly projects. I am passionate about building excellent software that improves the lives of those around me. Innovative Data Scientist focused on leveraging data to drive impactful insights.</p>
